...
import 'package:salam/widgets/cloud_icon.dart';
import 'package:salam/widgets/snow_icon.dart';
import 'package:salam/widgets/sun_icon.dart';
...
class _PageThreeState extends State<PageThree> {
                        ...
                        Column(
                          children: [
                            ...
                            Text('${cities[index].wind_speed1}m/s',
                                style: TextStyle(
                                    fontSize: 19, color: Colors.white)),
                            showWeatherIcon(cities[index].air_temperature1)
                          ],
                        ),
                        Column(
                          children: [
                            ...
                            Text('${cities[index].wind_speed2}m/s',
                                style: TextStyle(
                                    fontSize: 19, color: Colors.white)),
                            showWeatherIcon(cities[index].air_temperature2)
                          ],
                        ),
                        Column(
                          children: [
                            ...
                            Text('${cities[index].wind_speed3}m/s',
                                style: TextStyle(
                                    fontSize: 19, color: Colors.white)),
                            showWeatherIcon(cities[index].air_temperature3)
                          ],
                        )
                      ],
                    ),
  ...
  Widget showWeatherIcon([double temperature]) {
    if (temperature < 0) {
      return SizedBox(
        height: 60,
        child: Row(
          children: [
            SnowIcon(reverse: false),
            SnowIcon(reverse: true),
            SnowIcon(reverse: false),
          ],
        ),
      );
